					...
					<div class="nav-header">
						...
						<nav id="fh5co-menu-wrap" role="navigation">
							<ul class="sf-menu" id="fh5co-primary-menu">
								...
								<li><a href="login.html">Coaching Chatroom</a></li>
			...
			<div class="container">
				<div class="row about">
					<div class="col-md-12 col-md-offset-0">
						<img class="img-responsive animate-box" src="" alt="">
					</div>
...
s1.async=true;
s1.src='https://embed.tawk.to/5a0b2e6a198bd56b8c03b1da/default';
s1.charset='UTF-8';
...
<!--End of Tawk.to Script-->
	...
	<h3 class="section-title">Contact Customer Support</h3>
					...
					<div class="row copy-right">
						<div class="col-md-6 col-md-offset-3 text-center">
							...
							<p>Copyright 2017 Zero2Hero.com | All Rights Reserved. <br></p>
						</div>
					</div>
				</div>
			</div>
